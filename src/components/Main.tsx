...
const Main = (props: MainProps) => {
	...
	return (
		<div className="min-h-screen w-full flex flex-col gap-2">
			...
			<a
				href="mailto:steve@orbiter.host,justin@orbiter.host?subject=Orbiter%20Support%20Request"
				target="_blank"
				rel="noopener noreferrer"
				className="flex items-center justify-center fixed left-10 bottom-10 h-12 w-12 rounded-full bg-muted text-white"
			>
				<MessageCircleIcon />
			</a>
		</div>
